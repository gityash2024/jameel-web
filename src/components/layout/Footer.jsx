...
const Footer = () => {
  ...
  return (
    <div className="footer-container">
      <footer className="bg-white py-8 md:py-16 border-t" style={{ fontFamily: '"Apercu-Light", arial, sans-serif' }}>
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
            <div className="w-full">
              <h3 className="font-semibold mb-4 text-base" style={{ fontFamily: '"Apercu-Light", arial, sans-serif' }}>{footerData.personalised.title}</h3>
            ...
            <div className="w-full">
              <h3 className="font-semibold mb-4 text-base" style={{ fontFamily: '"Apercu-Light", arial, sans-serif' }}>{footerData.services.title}</h3>
              <ul className="space-y-2">
            ...
            <div className="w-full">
              <h3 className="font-semibold mb-4 text-base" style={{ fontFamily: '"Apercu-Light", arial, sans-serif' }}>{footerData.about.title}</h3>
              <ul className="space-y-2">
            ...
            <div className="w-full">
              <h3 className="font-semibold mb-4 text-base" style={{ fontFamily: '"Apercu-Light", arial, sans-serif' }}>{footerData.quickLinks.title}</h3>
              <ul className="space-y-2">
            ...
            <div className="w-full">
              <h3 className="font-semibold mb-4 text-base" style={{ fontFamily: '"Apercu-Light", arial, sans-serif' }}>{footerData.contact.title}</h3>
          ...
          <div className="mt-12 pt-8 border-t">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
              <div className="w-full md:w-auto">
                <h4 className="font-semibold mb-4 text-center md:text-left" style={{ fontFamily: '"Apercu-Light", arial, sans-serif' }}>FOLLOW US</h4>
              ...
              <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-6">
                <h4 className="font-semibold" style={{ fontFamily: '"Apercu-Light", arial, sans-serif' }}>FOLLOW US</h4>
